	...
	BEGIN 
		...
		SET XACT_ABORT ON
			...
			BEGIN TRAN
				...
				--INSERTA AL USUARIO
				INSERT INTO Usuario([Nombre_Usuario], [Clave], [Es_Admin])
				values (@inNombre, @inPassword, @inEs_Admin)
...
AS   
	BEGIN 
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear el Tipo Documento, por favor revise los datos',1;
		END CATCH
	END
GO
...
AS   
	BEGIN 
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear el Tipo Moneda, por favor revise los datos',1;
		END CATCH
	END
GO
...
AS   
	BEGIN 
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear el Parentezco, por favor revise los datos',1;
		END CATCH
	END
GO
...
AS   
	BEGIN 
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear el Tipo de Cuenta Ahorros, por favor revise los datos',1;
		END CATCH
	END
GO
...
AS   
	BEGIN 
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear la Persona, por favor revise los datos',1;
		END CATCH
	END
GO
...
AS   
	BEGIN 
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear el Cuenta, por favor revise los datos',1;
		END CATCH
	END
GO
...
AS   
	BEGIN 
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear el beneficiario, por favor revise los datos',1;
		END CATCH
	END
GO


-- Modificar los ultimos
-- Faltan Crear_Estado_Cuenta 
-- Usuario_Visualizacion
	...
	BEGIN 
		...
		SET XACT_ABORT ON
			...
			BEGIN TRAN
				...
				INSERT INTO Estado_Cuenta(Id_Persona, Id_Cuenta, Id_Parentezco, Porcentaje)
				values (@Id_Persona,@Id_Cuenta,@Id_Parentezco,@inPorcentaje)
		...
		BEGIN CATCH
			If @@TRANCOUNT > 0 
				ROLLBACK TRAN;
			THROW 62501,'Error: No se ha podido crear el Estado Cuenta, por favor revise los datos',1;
		END CATCH
	END
GO
